...
export SOURCE_DATE_SYSTEM=$(date +%s)
export KBUILD_BUILD_TIMESTAMP="$(date -d @${SOURCE_DATE_SYSTEM})"
export KBUILD_BUILD_HOST=build-host
export KBUILD_BUILD_USER=build-user
export KBUILD_BUILD_VERSION=1

echo "[ASUS] = SOURCE_DATE_EPOCH: ${SOURCE_DATE_EPOCH}"
echo "[ASUS] = SOURCE_DATE_SYSTEM: ${SOURCE_DATE_SYSTEM}"
echo "[ASUS] = KBUILD_BUILD_TIMESTAMP: ${KBUILD_BUILD_TIMESTAMP}"
