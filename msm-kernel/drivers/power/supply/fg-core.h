...
#define BATTERY_USE_TIME_CONDITION1  (3*30*24*60*60) //3Months //org 1Months
#define BATTERY_USE_TIME_CONDITION2  (6*30*24*60*60) //6Months //org 3Months
#define BATTERY_USE_TIME_CONDITION3  (12*30*24*60*60) //org 12Months
#define BATTERY_USE_TIME_CONDITION4  (18*30*24*60*60) //org 18Months
...
#define REQUEST_RELOAD_BAT_SAFETY           "1"
#define REQUEST_BACKUP_FG_SOC_REMAP_SCALE   "2"
