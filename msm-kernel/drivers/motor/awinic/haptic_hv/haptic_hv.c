...
static int rtp_osc_cali(struct aw_haptic *aw_haptic)
{
	...
	//Daniel 20230105 modify start
	aw_haptic->func->set_pwm(aw_haptic, AW_PWM_24K);
	//Daniel 20230105 modify end
	/* bst mode */
...
static void haptic_init(struct aw_haptic *aw_haptic)
{
	...
	aw_haptic->func->set_pwm(aw_haptic, AW_PWM_12K);//Daniel 20230105 modify ram sample 12K
	/* misc value init */
...
//printk("[haptic] aw_haptic driver version %s\n", HAPTIC_HV_DRIVER_VERSION);
	pr_info("<%s>%s: aw_haptic driver version %s\n", AW_I2C_NAME, __func__,
		HAPTIC_HV_DRIVER_VERSION);
	aw_dbg("aw_dbg working 1");
	aw_err("aw_err working 2");
	aw_info("aw_info working 3");
