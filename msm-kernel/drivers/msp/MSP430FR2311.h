...
static u8 panel_status; // 0 : panel off, 1 : panel on
#define WAKELOCK_HOLD_TIME 2200 /* in ms */
static bool openclose_worker_running;
...
struct MSP430FR2311_info {
	...
	struct workqueue_struct		*sleep_workqueue;
	struct delayed_work 		sleep_delayed_work;
