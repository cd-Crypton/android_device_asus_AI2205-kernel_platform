...
#define FTS_REG_SLIDING_SMOOTHNESS          0x92

#define FTS_REG_REPORT_RATE                 0x88
#define FTS_REG_REPORT_RATE_BURST           0xE3

#define MAX_ATR_TOUCH_NUMBER                10
#define MAX_I2C_TOUCH_NUMBER                FTS_MAX_POINTS_SUPPORT /* should be 10 */
